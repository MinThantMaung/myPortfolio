    ...
    return (
        <div className="w-full h-screen bg-white">
            ...
            <div className="flex flex-col justify-center items-center h-full text-xl">
                <a href="#home" className="font-bold" onClick={handleMenuClose}>
                    Home
                </a>
                ...
                <a href="#skill" className="font-bold mt-6" onClick={handleMenuClose}>
                    Skills
                </a>
                <a href="#project" className="font-bold mt-6" onClick={handleMenuClose}>
                    Projects
                </a>
                <a href="#contact" className="font-bold mt-6" onClick={handleMenuClose}>
                    Contact
                </a>
            </div>
        </div>
