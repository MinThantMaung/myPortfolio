...
const Home = () => {
    ...
    return (
        <div>
            <div className="w-full h-screen bg-gray-50 dark:bg-dark dark:text-white">
                <div className="font-bold sm:text-6xl text-5xl text-center text-black dark:text-white pt-20 sm:pt-0">
